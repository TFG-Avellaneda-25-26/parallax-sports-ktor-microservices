...
object EmbedFactory {
    ...
    fun eventCard(eventName: String, imageUrl: String): EmbedBuilder {
        return base()
            .setTitle("!New event Detected")
            .setDescription("Notified event $eventName")
            .setImage(imageUrl)
            .setColor(Color.CYAN)
            .setFooter("ParallaxBot - TFG", null)
    }
}